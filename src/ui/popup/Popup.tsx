...
const styles: Record<string, React.CSSProperties> = {
  container: { display: 'flex', flexDirection: 'column', minHeight: '200px' },
  header: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px', borderBottom: '1px solid #ced0d4', background: '#f0f2f5' },
  logo: { display: 'flex', alignItems: 'center', gap: '8px' },
  logoIcon: { fontSize: '20px' },
  logoText: { fontWeight: '700', fontSize: '15px', color: '#e04f5f' },
  version: { fontSize: '11px', color: '#65676b' },
  content: { padding: '16px', flex: 1 },
  statsGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '16px' },
  statCard: { padding: '12px', background: '#f0f2f5', borderRadius: '8px', textAlign: 'center' as const },
  statNumber: { fontSize: '24px', fontWeight: '700', color: '#1c1e21' },
  statLabel: { fontSize: '11px', color: '#65676b', marginTop: '2px' },
  primaryButton: { width: '100%', padding: '10px 16px', background: '#e04f5f', color: '#ffffff', border: 'none', borderRadius: '8px', fontSize: '14px', fontWeight: '600', cursor: 'pointer' },
  notOnMarketplace: { textAlign: 'center' as const },
  infoText: { color: '#65676b', marginBottom: '16px', lineHeight: '1.4' },
  footer: { padding: '8px 16px', borderTop: '1px solid #ced0d4', fontSize: '11px', color: '#65676b', textAlign: 'center' as const },
  footerLink: { color: '#1877f2', textDecoration: 'none' },
